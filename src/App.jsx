...
function loadPins(){
  try{ return JSON.parse(localStorage.getItem("gymtrack-pins")||"null")||DEFAULT_PINS; }
  catch{ return DEFAULT_PINS; }
}
function savePins(pins){ localStorage.setItem("gymtrack-pins", JSON.stringify(pins)); }

function loadSession(){
  try{ return localStorage.getItem("gymtrack-role")||null; }
  catch{ return null; }
}
function saveSession(role){ localStorage.setItem("gymtrack-role", role||""); }
...
export default function App(){
  ...
  // Wait until session checked
  if(!roleReady) return(
    <div style={{minHeight:"100vh",background:"#09090b",display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{color:"#71717a",fontSize:"0.875rem"}}>Cargando...</div>
    </div>
  );
